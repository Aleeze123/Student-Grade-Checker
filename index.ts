...
let student: studentName = await inquirer.prompt({
    name: "name",
    message: "Enter student name....."
});

let marksInput: studentMarks = await inquirer.prompt({
    name: "marks",
    message: "Enter student marks....."
});

let marks: number = parseInt(marksInput.marks); // Convert the input to an integer
